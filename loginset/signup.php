...
<html lang="en">
  ...
  <body>
    ...
    <h1 class="text-center">Signup to our website for a new account..!!</h1>
    <form action="/loginset/signup.php" method ="post">
        <div class="form-group col-md-6">
            <label for="username" class="form-label">User Name</label>
            <input type="text" maxlength= "40" class="form-control" id="username" name="username">
